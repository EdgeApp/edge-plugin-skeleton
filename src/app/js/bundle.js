...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__ = __webpack_require__(1);
...
__WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["a" /* config */].get('API_TOKEN')
  ...
  .catch((reason) => {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#apiToken').html(reason)
  })

__WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].selectedWallet()
  .then((data) => {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#currentWallet').html(JSON.stringify(data))
    return true
  })
  .catch((reason) => {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#currentWallet').html(JSON.stringify(reason))
  })

__WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].readData('app-data')
  .then((data) => {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#data').val(data)
    return true
  })
  .catch((reason) => {
    __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].debugLevel(1, JSON.stringify(reason))
  })

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#writeData').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].writeData('app-data', __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#data').val()).then((data) => {
    __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].debugLevel(1, 'Data written')
    return true
  })
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#clearData').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].clearData().then((data) => {
    __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].debugLevel(1, 'Data cleared')
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#data').val('')
    return true
  })
})
...
const updateWallets = function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].wallets().then((data) => {
    if (data.length > 0) {
      const wallet = data[0]
      __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.each(data, (index, value) => {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('walletSelection').add('<option>' + value.currencyCode + ' - ' + value.id + '</option>')
      })
    ...
    .catch((reason) => {
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#walletsData').val(JSON.stringify(reason))
    })
}
// Fetch all wallets selected wallet
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#wallets').click(function () {
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#walletsData').html('fetching wallets...')
  updateWallets()
})
updateWallets()

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#changeWallet').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].chooseWallet().then((data) => {
    return true
  })
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#send').click(function () {
  const $address = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#sendAddress')
  const $amount = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#sendAmount')
  if ($address.val() === '') {
    window.alert('Please provide a destination address')
  } else {
    __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].requestSpend(null, $address.val(), $amount.val(), {})
      .then(function () {
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#debugLevel').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["b" /* core */].debugLevel(1, 'Debug statement')
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#title').keyup(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].title(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).val())
})
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#title').keyup()

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#showAlert').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].showAlert(true, 'Test Alert', 'This is the message')
  setTimeout(function () {
    __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].hideAlert()
  }, 2000)
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#openAirbitz').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].launchExternal('https://airbitz.co')
})
...
let navCount = 0
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#navPush').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].navStackPush(navCount.toString())
  navCount += 1
  window.history.pushState({navCount}, navCount.toString(), navCount + '.html')
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#navPop').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].navStackPop()
    .then(data => {
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#navClear').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].navStackClear()
  navCount = 0
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#back').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].back()
})

__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#exit').click(function () {
  __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__["c" /* ui */].exit()
})
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return core; });
...
function bitidSignature(uri, message) {
  return postWrapper({ func: 'bitidSignature', uri: uri, message: message });
}
...
function wallets(options) {
  return postWrapper({ func: 'wallets', options: options });
}
...
function getAddress(walletId, currencyCode) {
  return postWrapper({ func: 'getAddress', walletId: walletId, currencyCode: currencyCode });
}
...
function finalizeReceiveRequest(wallet, requestId) {
  return postWrapper({ func: 'finalizeReceiveRequest', wallet: wallet, requestId: requestId });
}
...
function broadcastTx(wallet, rawtx) {
  return postWrapper({ func: 'broadcastTx', wallet: wallet, rawtx: rawtx });
}
...
function saveTx(wallet, rawtx) {
  return postWrapper({ func: 'saveTx', wallet: wallet, rawtx: rawtx });
}
...
function writeData(key, value) {
  return postWrapper({ func: 'writeData', key: key, value: value });
}
...
function readData(key) {
  return postWrapper({ func: 'readData', key: key });
}
...
function debugLevel(level, text) {
  return postWrapper({ func: 'debugLevel', level: level, text: text });
}
...
var core = /*#__PURE__*/Object.freeze({
  bitidAddress: bitidAddress,
  bitidSignature: bitidSignature,
  chooseWallet: chooseWallet,
  selectedWallet: selectedWallet,
  wallets: wallets,
  getAddress: getAddress,
  finalizeReceiveRequest: finalizeReceiveRequest,
  requestSpend: requestSpend,
  createSpendRequest2: createSpendRequest2,
 ...
 */
function get(key) {
  return postWrapper({ func: 'get', key: key });
}
...
function showAlert(success, title, message, options) {
  return postWrapper({ func: 'showAlert', success: success, title: title, message: message });
}
...
function launchExternal(uri) {
  return postWrapper({ func: 'launchExternal', uri: uri });
}
...
function navStackPush(path) {
  return postWrapper({ func: 'navStackPush', path: path });
}
