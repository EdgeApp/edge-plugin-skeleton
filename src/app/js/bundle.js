...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_edge_libplugin__ = __webpack_require__(2);
 ...
 */
function createSpendRequest (wallet, toAddress, nativeAmount, options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({
...
function showAlert (success, title, message, options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'showAlert', success, title, message})
}
